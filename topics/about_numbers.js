...
test("types", function() {
    ...
    equals(typeOfIntegers === typeOfFloats, false, 'are ints and floats the same type?');
    equals(typeOfIntegers, "int, 'what is the javascript numeric type?');
...
test("NaN", function() {
    ...
    equals(resultOfFailedOperations == NaN, true, 'is NaN == NaN?');
});
